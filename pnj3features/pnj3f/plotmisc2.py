...
def plot_months(classify_model, classify_period, classify_level, pathh5, pathclass, pathplot):
    ...
    if 'uamap_normalPNJ' in grp0.keys():
        ...
        # import matplotlib.pyplot as plt
        # mapplot = np.reshape(classmap_normalPNJ, [len(nc_lat_data), len(nc_lon_data)])
        # plt.imshow(mapplot, origin='lower')
        # plt.show()
    ...
    if 'uamap_type1event' in grp0.keys():
        ...
        # import matplotlib.pyplot as plt
        # mapplot = np.reshape(classmap_type1event, [len(nc_lat_data), len(nc_lon_data)])
        # plt.imshow(mapplot, origin='lower')
        # plt.show()
    ...
    if 'uamap_type2event' in grp0.keys():
        ...
        # import matplotlib.pyplot as plt
        # mapplot = np.reshape(classmap_type2event, [len(nc_lat_data), len(nc_lon_data)])
        # plt.imshow(mapplot, origin='lower')
        # plt.show()
